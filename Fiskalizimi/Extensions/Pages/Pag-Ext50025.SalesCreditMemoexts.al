pageextension /*50305*/50025 "Sales Credit Memo exts" extends "Sales Credit Memo"
{
    layout
    {
                    ...
                    begin
                        if (rec."Corrective/Is Bad Debt Invoice" = rec."Corrective/Is Bad Debt Invoice"::" ") then begin
                            ...
                            if rec."Corrective/Is Bad Debt Invoice" = rec."Corrective/Is Bad Debt Invoice"::"Is Corrective" then begin
                                ...
                                if rec."Corrective/Is Bad Debt Invoice" = rec."Corrective/Is Bad Debt Invoice"::"Is Bad Debt Invoice" then begin
                                    gEditableCorrective := false;
                                    rec."Correc. Inv Type" := rec."Correc. Inv Type"::" ";
                                end;
                        end;
    ...
    var
        ...
        ErrorTxt003: Label 'End Date s''mund te jete para Start Date';//End Date can not be before Start Date
        gEditableCorrective: Boolean;
        gEditableImport: Boolean;
