tableextension /*50303*/50025 "Sales Cr.Memo Header exts" extends "Sales Cr.Memo Header"
{
    fields
    {
        ...
        field(50315; "Credit Memo Business Process"; Enum "Credit Memo Business Process")
        {
