tableextension /*50305*/50027 "Sales Header Exts" extends "Sales Header"
{
    fields
    {
        ...
        modify("Sell-to Customer No.")
        {
            ...
            begin
                if Cust.Get(Rec."Sell-to Customer No.") then begin
                    Rec.Validate("Type of Self Iss", Cust."Type of Self ISS");
                    Rec.Validate("Invoice Type", Cust."Type of Inovice");
                    Rec.Validate("Is Simplified Inv", Cust."Is Simplified Invoice");
                    Rec.Validate("Is Reversed", Cust."Is Reversed Charge");
                    Rec.Validate("Delivery Require", Cust."Delivery Require");
                end;
            end;
        }
        ...
        field(50330; "E-CreditMemo Type Code"; Enum "E-Credit Memo Type Code")
        {
        ...
        field(50340; "Credit Memo Business Process"; Enum "Credit Memo Business Process")
        {
            Caption = 'Credit Memo Business Process';
            DataClassification = ToBeClassified;
        }
    }
}