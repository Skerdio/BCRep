page 50030 "Change Purchase Inv"
{
    Caption = 'Change Purchase Inv';
    ...
    begin
        if CloseAction = ACTION::LookupOK then
            if (Rec."Posting Date" <> xRecPIH."Posting Date") or
                ...
                (Rec."Vendor Invoice No." <> xRecPIH."Vendor Invoice No.") or
    ...
    var
        ...
        // CompWithhTax2: Record "Computed Withholding Tax";
    ...
    //AX-s
    procedure SetDoc(pEntryType: Option; pDocType: Option; pPIH: Record "Purch. Inv. Header")
    begin
        ...
        OldExtDocNo := pPIH."Vendor Invoice No.";
        Rec := pPIH;
        Rec.Insert();
